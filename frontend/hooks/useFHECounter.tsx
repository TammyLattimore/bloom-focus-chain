...
/*
  ...
  - NEXT_PUBLIC_FHE_COUNTER_ADDRESS_HARDHAT (for chainId 31337)
  - NEXT_PUBLIC_FHE_COUNTER_ADDRESS_SEPOLIA (for chainId 11155111)
*/
import { FHECounterAddresses, getFHECounterAddress } from "@/abi/FHECounterAddresses";
 ...
 *
 * @param chainId - Target chain id (e.g., 31337, 11155111). `undefined` returns ABI-only.
...
function getFHECounterByChainId(
  ...
  const dynamicAddress = getFHECounterAddress(chainId);
